...
**Original objective (as assigned):** Meet three times with cross-department students for assignments.
...
Employer surveys (e.g., NACE Job Outlook 2025) and prior interdisciplinary CS-and-design capstone work (Performamatics; Georgia Tech Junior Design; Mahnič's Scrum capstone study) consistently report that cross-functional collaboration is a skill students benefit from rehearsing in school rather than encountering for the first time on the job — which is the premise this initiative was built on.
...
- CS teams reported that design integration substantially improved perceived project quality [SOURCE NEEDED: survey/retro/transcript]
- GRD students reported meaningful gains in understanding technical constraints and iterative feedback processes [SOURCE NEEDED: survey/retro/transcript]
- Both cohorts identified the formal handoff structure as the element most responsible for reducing last-minute communication crises [SOURCE NEEDED: survey/retro/transcript]
...
**Original objective:** Meet three times with cross-department students for assignments.

**What was delivered:** The three meetings happened — formalized as Touchpoints 1, 2, and 3 in the protocol above. Documentation, a milestone structure, and a collaboration rubric were produced as byproducts and are available if anyone wants them.
